...
import serviceListExporterFields from '@/modules/service/service-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!serviceListExporterFields || !serviceListExporterFields.length) {
          throw new Error('serviceListExporterFields is required');
        }
