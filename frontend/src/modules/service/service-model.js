...
function label(name) {
  return i18n(`entities.service.fields.${name}`);
}

function enumeratorLabel(name, value) {
  return i18n(`entities.service.enumerators.${name}.${value}`);
}
...
const fields = {
  ...
  isActive: new BooleanField('isActive', label('isActive')),
...
export class ServiceModel extends GenericModel {
  static get fields() {
    return fields;
  }
}
