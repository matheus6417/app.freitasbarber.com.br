<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/service/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/service/import' }" v-if="hasPermissionToImport">
...
export default {
  name: 'app-service-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'service/list/hasRows',
      loading: 'service/list/loading',
      exportLoading: 'service/list/exportLoading',
      selectedRows: 'service/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new ServicePermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new ServicePermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'service/list/doExport',
      doRemoveAllSelected:
        'service/list/doRemoveAllSelected',
      doDisableAllSelected:
        'service/list/doDisableAllSelected',
      doEnableAllSelected:
        'service/list/doEnableAllSelected',
      doDestroyAll: 'service/destroy/doDestroyAll',
    }),
