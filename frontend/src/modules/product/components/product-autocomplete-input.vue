...
<script>
import ProductFormModal from '@/modules/product/components/product-form-modal';
import { ProductPermissions } from '@/modules/product/product-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-product-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [ProductFormModal.name]: ProductFormModal,
  },
