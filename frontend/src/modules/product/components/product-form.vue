  ...
  <div>
    ...
    >
      <el-form-item :label="fields.id.label" :prop="fields.id.name" v-if="isEditing">
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input-number :precision="fields.costPrice.scale" :step="0.1" v-model="model[fields.costPrice.name]" ></el-input-number>
          </el-col>
        </el-form-item>
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-date-picker placeholder type="date" v-model="model[fields.dateCheck.name]"></el-date-picker>
          </el-col>
        </el-form-item>
