<template>
  <div>
    <el-form
      ...
      v-if="model"
    >
      <!-- <el-form-item :prop="fields.id.name" v-if="isEditing">
      ...
      <el-form-item :prop="fields.birthdate.name" :required="fields.birthdate.required">
        <el-col :lg="11" :md="16" :sm="24">
          <el-date-picker
            :placeholder="fields.birthdate.label"
            type="date"
      ...
      <el-form-item :prop="fields.adress.name" :required="fields.adress.required">
        <el-col :lg="11" :md="16" :sm="24">
          <el-input :placeholder="fields.adress.label" v-model="model[fields.adress.name]" />
        </el-col>
      </el-form-item>

      <el-form-item :prop="fields.phone1.name" :required="fields.phone1.required">
        <el-col :lg="11" :md="16" :sm="24">
          <el-input :placeholder="fields.phone1.label" v-model="model[fields.phone1.name]" />
        </el-col>
      </el-form-item>

      <el-form-item :prop="fields.phone2.name" :required="fields.phone2.required">
        <el-col :lg="11" :md="16" :sm="24">
          <el-input :placeholder="fields.phone2.label" v-model="model[fields.phone2.name]" />
        </el-col>
      </el-form-item>
      ...
      >
        <el-col :lg="11" :md="16" :sm="24">
          <el-input
            :placeholder="fields.relationDescription.label"
            v-model="model[fields.relationDescription.name]"
          />
        </el-col>
      </el-form-item>
      <!-- 
