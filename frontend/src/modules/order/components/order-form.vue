  ...
  <div>
    ...
    >
      <el-form-item :label="fields.id.label" :prop="fields.id.name" v-if="isEditing">
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input-number :precision="fields.total.scale" :step="0.1" v-model="model[fields.total.name]" ></el-input-number>
          </el-col>
        </el-form-item>
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input-number :precision="fields.valueAlt.scale" :step="0.1" v-model="model[fields.valueAlt.name]" ></el-input-number>
          </el-col>
        </el-form-item>
