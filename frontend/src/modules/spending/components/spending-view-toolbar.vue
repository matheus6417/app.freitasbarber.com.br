<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: `/spending/${record.id}/edit` }" v-if="record && hasPermissionToEdit">
    ...
    <el-button
      ...
      icon="el-icon-fa-trash" type="text"
...
export default {
  name: 'app-spending-view-toolbar',
  ...
  computed: {
    ...
    hasPermissionToImport() {
      return new SpendingPermissions(this.currentUser).import;
    },
