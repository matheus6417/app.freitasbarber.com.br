...
<script>
import SpendingFormModal from '@/modules/spending/components/spending-form-modal';
import { SpendingPermissions } from '@/modules/spending/spending-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-spending-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [SpendingFormModal.name]: SpendingFormModal,
  },
