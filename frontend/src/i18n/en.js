const en = {
  ...
  entities: {
    ...
    service: {
      ...
      destroyAll: {
        success: 'Service(s) deleted successfully',
      },
      edit: {
        title: 'Edit Service',
      },
    ...
    spending: {
      ...
      label: 'Spendings',
      menu: 'Spendings',
      exporterFileName: 'spending_export',
      list: {
        menu: 'Spendings',
        title: 'Spendings',
      },
      create: {
        success: 'Spending saved successfully',
      },
      update: {
        success: 'Spending saved successfully',
      },
      destroy: {
        success: 'Spending deleted successfully',
      },
      destroyAll: {
        success: 'Spending(s) deleted successfully',
      },
      edit: {
        title: 'Edit Spending',
      },
      ...
      importer: {
        title: 'Import Spendings',
        fileName: 'spending_import_template',
        hint:
          'Files/Images columns must be the URLs of the files separated by space.',
      },
    },
  ...
  roles: {
    ...
    serviceEditor: {
      ...
      description: 'Edit access to Services',
    },
    serviceViewer: {
      label: 'Service Viewer',
      description: 'View access to Services',
    },
    spendingEditor: {
      label: 'Spending Editor',
      description: 'Edit access to Spendings',
    },
    spendingViewer: {
      label: 'Spending Viewer',
      description: 'View access to Spendings',
    },
  },
